...
class WorkOrdersBuilder extends Component {
    ...
    async componentDidMount() {
        ...
        detailsdata = await this.props.fetchDetailsWOData(dtlsID)
...
const mapDispatchToProps = dispatch => ({
    ...
    fetchDetailsWOData: async () => await dispatch(fetchDetailsWOData(dtlsID, token)),
    ...
    fetchNotesWOData: ()=> dispatch(fetchNotesWOData(token)),
